...
echo GL
d=$(./download.sh "https://www.gl.ch/verwaltung/finanzen-und-gesundheit/gesundheit/coronavirus.html/4817" | egrep "Fallzahlen Kanton Glarus.+Update|Bestätigte Fälle|Wahrscheinliche Fälle")
