...
print('Hospitalized:', sc.find(r'>Hospitalisationen Isolation \(akt(?:\.|ueller) Stand\)<\/td>\s*<td[^>]*>([0-9]+)<', d.replace("\n", "")))
print('ICU:', sc.find(r'>Hospitalisationen Intensiv \(akt(?:\.|ueller) Stand\)<\/td>\s*<td[^>]*>([0-9]+)<', d.replace("\n", "")))
